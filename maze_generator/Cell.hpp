   ...
   void draw(sf::RenderWindow& window) {
    ...
    if(isVisited) {
     ...
     if(walls[cellWalls.Top]) {
       ...
       topLine[0].color = sf::Color(183, 183, 183);
        topLine[1].color = sf::Color(183, 183, 183);
       window.draw(topLine);
     }
     ...
     if(walls[cellWalls.Right]) {
       ...
       rightLine[0].color = sf::Color(183, 183, 183);
    rightLine[1].color = sf::Color(183, 183, 183);
     ...
     if(walls[cellWalls.Bottom]) {
       ...
       bottomLine[1] = sf::Vector2f(x , y + width);
        bottomLine[0].color = sf::Color(183, 183, 183);
    bottomLine[1].color = sf::Color(183, 183, 183);
     ...
     if(walls[cellWalls.Left]) {
       ...
       leftLine[1] = sf::Vector2f(x , y);
        leftLine[0].color = sf::Color(183, 183, 183);
    leftLine[1].color = sf::Color(183, 183, 183);
